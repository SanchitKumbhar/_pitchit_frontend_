...
const HiringForm = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-8 space-y-5 text-gray-800 shadow-lg border border-gray-100">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          <img src="/logo.png" alt="Logo" className="w-12 h-12" />
          <h1 className="text-3xl font-bold text-blue-600">pitchlt</h1>
        </div>
  ...
  <hr className="border-gray-300 mb-20" />
      ...
      <div className="relative w-full mb-10">
        ...
        <div className="absolute w-full top-[-35px] flex justify-between text-sm font-medium">
            ...
            <div className="flex flex-wrap gap-3 mt-2">
              {skillsList.map((skill) => (
                <span
                  ...
                  className={`px-4 py-2 shadow-sm rounded-full cursor-pointer transition-colors ${
          ...
          <div>
            ...
            >
              {formData.resumeFile ? (
                ...
                <p className="text-gray-500">Click or drag a PDF file here</p>
              )}
              <button
                type="button"
